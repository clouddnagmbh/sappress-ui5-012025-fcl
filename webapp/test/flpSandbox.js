		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atclouddnafcl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnafcl-display": {
								"semanticObject": "atclouddnafcl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.fcl",
									"url": sap.ui.require.toUrl("at/clouddna/fcl")
								}
							}
						}
					}
